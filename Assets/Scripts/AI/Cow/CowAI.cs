...
namespace CrashedWorld
{
    public class CowAI : MonoBehaviour
    {
        ...
        private void Flee()
        {
            //  The enemy is runing away from the player
            m_PlayerNear = false;                       //  Set false that the player is near because the PNJ already sees the player
